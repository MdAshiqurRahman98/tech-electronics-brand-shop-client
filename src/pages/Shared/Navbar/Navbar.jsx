    ...
    return (
        <div>
            <nav className="flex justify-between py-1 mb-3 items-center">
                <figure className="flex items-center"><img className="w-[300px] h-[100px] -ml-20 mt-2" src="https://i.ibb.co/sqGzrrM/logo.png" alt="Logo" /><span className="text-2xl font-bold -ml-16">Brand Shop</span></figure>
