...
const UpdateProduct = () => {
    ...
    const handleUpdateProduct = event => {
        ...
        fetch(`https://coffee-store-server-with-auth-agtz9y30j.vercel.app/coffee/${_id}`, {
            method: 'PUT',
            headers: {
    ...
    return (
        <div className="bg-[#F4F3F0] p-24 mb-5">
            ...
            <form onSubmit={handleUpdateProduct}>
                ...
                <input type="submit" value="Update Product" className="btn btn-block text-white bg-[#FF444A] hover:bg-[#FF444A] normal-case" />
